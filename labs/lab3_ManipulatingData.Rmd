...
When performing logical indexing, you supply a vector specifying whether to extract a specfic element (with a `TRUE`) or to *not* extract a specfic element (with a `FALSE`).
